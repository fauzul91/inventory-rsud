    ...
    */
    ...
    'options' => [
        ...
        'defines' => [
            ...
            'pdf_backend' => 'CPDF',
            'default_media_type' => 'screen',
            'default_paper_size' => 'legal', // Set default ke legal
            'default_paper_orientation' => 'portrait',
            'default_font' => 'serif',
            'dpi' => 96,
            'enable_php' => false,
            'enable_javascript' => true,
            'enable_remote' => true, // PENTING: Enable untuk base64 images
            'font_height_ratio' => 1.1,
            'enable_html5_parser' => true, // PENTING: Enable HTML5 parser
        ],
    ],
